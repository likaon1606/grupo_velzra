    ...
    <div className="menu">
      <div className="navbar">
        ...
        <div className="icons-social">
          <a
            href="https://www.facebook.com/profile.php?id=100087222829837"
            target="blank"
          >
            <span>
              <svg
          ...
          <a
            href="https://api.whatsapp.com/send/?phone=5641815041&text=%C2%A1Hola!,%20requiero%20m%C3%A1s%20informaci%C3%B3n."
            target="blank"
          >
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          ...
          <a href="mailto:ventas@grupovelzra.com" target="blank">
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
